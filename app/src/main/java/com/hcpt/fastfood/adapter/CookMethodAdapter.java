...
public class CookMethodAdapter extends BaseAdapter {
	...
	public CookMethodAdapter(Context activity,
			ArrayList<CookMethod> arrCookMethod, Item item) {
		this.arrCookMethods = arrCookMethod;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (cookMethod != null) {
			...
			if (cookMethod.equals(currentItem.getSelectedCookMethod())) {
