...
public class FilterAdapter extends BaseAdapter {
	...
	public FilterAdapter(Context activity, String role) {
		this.mArrCategory = new ArrayList<String>();
		switch (role) {
		case Constant.ROLE_ADMIN_USER:
			mArrCategory.add(Constant.STATUS_7);
	...
	public void setSelectedStringByNumber(String status) {
		...
		case Constant.STATUS_ON_THE_WAY:
			...
			break;
		case Constant.STATUS_ALL:
			selectedStatus = Constant.STATUS_7;
			break;
		}
	}
