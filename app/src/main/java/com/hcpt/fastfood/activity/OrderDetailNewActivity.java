...
public class OrderDetailNewActivity extends BaseActivity implements
		OnClickListener {
						...
						new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialogSub,
								...
								case Constant.ROLE_ADMIN_USER:
									updateOrder(currentOrder.getId(), adapter
	...
	public void updateOrderDelivery(String orderId, String status) {
		ModelManager.updateNewOrderDelivery(this, true, orderId, status,
				currentUser.getId(), new ModelManagerListener() {
					@Override
					public void onSuccess(String json) {
	...
	public void updateOrderChef(String orderId, String status) {
		ModelManager.updateNewOrderChef(this, true, orderId, status,
				currentUser.getId(), new ModelManagerListener() {
					@Override
					public void onSuccess(String json) {
						// TODO Auto-generated method stub
